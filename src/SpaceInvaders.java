...
public class SpaceInvaders extends JPanel implements ActionListener, KeyListener {
    ...
    SpaceInvaders(){
        ...
        //Detecta al presionar flechas de direccion
        setFocusable(true);
        addKeyListener(this);
        ...
        alienYellowingImg = new ImageIcon(getClass().getResource("./alien-yellow.png")).getImage();

        alienImgArray = new ArrayList<Image>();
        alienImgArray.add(alienImg);
        alienImgArray.add(alienCyanImg);
        alienImgArray.add(alienMagentaImg);
        alienImgArray.add(alienYellowingImg);
    ...
    public void move() {
        ...
        //next level
        if (alienCount == 0) {
            //increase the number of aliens on columms and rows by 1
    ...
    public void keyReleased(KeyEvent e) {
        if(gameOver) {
            ...
            Block bullet = new Block(ship.x + shipWidth*15/32, ship.y, bulletWidth, bullletHeight, null);
